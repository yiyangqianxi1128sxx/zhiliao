...
// import 'package:patient_project/Database/MysqlConnection.dart';
...
class _Logoing extends State<Logo> {
  ...
  // init() async {
  //   print('配置数据库链接');
  //   var str = ConnectionSettings(
  //     user: "root", //todo:用户名
  //     password: "123", //todo:密码
  //     host: "10.0.2.2", //todo:flutter中电脑本地的ip
  //     port: 3306, //todo:端口
  //     db: "patient", //todo:需要连接的数据库
  //   );
  //   print('配置数据库');
  //   //todo:获取数据库连接
  //   await MySqlConnection.connect(str).then((_) {
  //     conn = _;
  //     print('连接成功');
  //   });
  // }
